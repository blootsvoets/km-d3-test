...
new Moonboots({
    moonboots: {
        jsFileName: 'kumbh-mela-graph',
        cssFileName: 'kumbh-mela-graph',
...
console.log('Kumbh Mela graph is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
