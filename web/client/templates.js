(function (root, factory) {
    ...
    // pages/graph.jade compiled template
    templatizer["pages"]["graph"] = function tmpl_pages_graph(locals) {
        var buf = [];
        var jade_mixins = {};
        var jade_interp;
        return buf.join("");
